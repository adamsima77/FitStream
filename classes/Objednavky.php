...
namespace FitStream\Objednavky;
...
class Objednavky extends Database
{
  ...
  public function getPlatba(int $id): array
  {
      if ($this->conn === null) {
          $this->connect();
          $this->conn = $this->getConnection();
    ...
    public function getDoprava(int $id): array
    {
        if ($this->conn === null) {
            $this->connect();
            $this->conn = $this->getConnection();
    ...
    public function ukladanieDoDatabazy(string $email,string $meno, string $priezvisko,
                                        string $telefonne_cislo, string $mesto, string $ulica, string $psc, 
                                        int $platba,int $doprava, ?int $id_uzivatela,
