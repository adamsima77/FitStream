        ...
        <table>
            ...
            <?php foreach($vypis_navbar as $polozka_navbar):?>
                <tr>
                    ...
                    <td><a href="<?php echo BASE_URL; ?>admin/editovanie/editovanie_navbaru.php?id=<?php echo $id;?>" class = "edit">Editovať</a> <a href = "<?php echo BASE_URL; ?>admin/vymazanie/vymazanie_navbar.php?id=<?php echo $id;?>" onclick = "return kontrolaVymazania()" class = "delete">Vymazať</a></td>
                </tr>
            <?php endforeach;?>
