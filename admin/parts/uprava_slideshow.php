            ...
            <table>
                ...
                <?php foreach($vypis_slideshow as $polozka_slideshow): ?>
                    <tr>
                        ...
                        <td>
                            <a href="<?php echo BASE_URL; ?>admin/editovanie/editovanie_slideshow.php?id=<?php echo $id; ?>" class="edit">Editovať</a>
                            <a href="<?php echo BASE_URL; ?>admin/vymazanie/vymazanie_slideshow.php?id=<?php echo $id; ?>" onclick="return kontrolaVymazania()" class="delete">Vymazať</a>
                        </td>
                    </tr>
                <?php endforeach; ?>
            </table>
